...
struct packet_game_info {
  ...
  int tech_upkeep_style;
  int timeout;
  bool tired_attack;
  int trademindist_old;
  int trademindist_new;
  bool trading_city;
  bool trading_gold;
  bool trading_tech;
  int turn;
...
struct packet_city_info {
  ...
  int food_stock;
  int shield_stock;
  int trade[NUM_TRADE_ROUTES];
  int trade_value[NUM_TRADE_ROUTES];
  int pollution;
  int illness_trade;
  int production_kind;
...
struct packet_player_info {
  ...
  int science;
  int luxury;
  int bulbs_last_turn_old;
  int bulbs_last_turn_new;
...
struct packet_unit_info {
  ...
  int hp;
  int fuel;
  int activity_count_old;
  int changed_from_count_old;
  int activity_count_new;
  int changed_from_count_new;
  int goto_tile;
...
struct packet_edit_startpos_full *receive_packet_edit_startpos_full(struct connection *pc, enum packet_type type);
