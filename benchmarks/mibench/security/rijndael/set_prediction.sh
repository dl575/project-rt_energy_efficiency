...
SOURCE_FILES=("mibench/security/rijndael/aesxam.c")
SOURCE_PATH=("mibench/security/rijndael") 
...
rm -rf $DATA_PATH/rijndael/rijndael0.txt
mv output_slice.txt $DATA_PATH/rijndael/rijndael0.txt
